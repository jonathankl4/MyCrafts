...
class Lemari3Controller extends Controller
{
    //
    ...
    public function testing()
    {
        ...
        // dd($addonPrices);
        return view('seller.produkCustom.produk.testing.lemari3.h1lemari3', ['user' => $user, 'detail' => $detail, 'addonPrices' => $addonPrices, 'listAddOnMain' => $addonMain, 'produk'=>$produk]);
    }
    ...
    public function testing2(){
        ...
        return view('seller.produkCustom.produk.testing.lemari3.h2lemari3', ['user'=>$user, 'listPintu'=>$addonSecond, 'addonPrices'=>$addonPrices]);
