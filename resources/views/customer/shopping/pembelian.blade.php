...
@section('style')
    <style>
        ...
        .status-pengajuanRetur {
            background-color: #E0E7FF;
            color: #3730A3;
        }
        .status-returDiterima {
            background-color: #E0E7FF;
            color: #3730A3;
        }
        .status-pengirimanKembali {
            background-color: #E0E7FF;
            color: #3730A3;
        }
                                            ...
                                            <div class="p-4">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <p class="mb-0">
                                                            <span
                                                                class="badge {{ $order->tipe_trans == 'custom' ? 'bg-warning' : 'bg-info' }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        @if ($order->tipe_trans == 'custom')
                                                            <div class="mb-2">
                                                                ...
                                                                <div class="price-value">
                                                                    Rp.
                                                                    {{ number_format($order->perkiraan_harga, 0, ',', '.') }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                        ...
                                                        @if ($order->harga_redesain != null)
                                                            <div>
                                                                ...
                                                                <div class="price-value">
                                                                    Rp.
                                                                    {{ number_format($order->harga_redesain + $order->ongkir, 0, ',', '.') }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 text-end">
                                                        @php
                                                            $statusClass = match ($order->status) {
                                                                ...
                                                                3 => 'status-menunggu',
                                                                4 => 'status-produksi',
                                                                5 => 'status-selesaiproduksi',
                                                                11 => 'status-siapkirim',
                                                                6 => 'status-dikirim',
                                                                7 => 'status-selesai',
                                                                8, 9, 10 => 'status-batal',
                                                                12 => 'status-sampai',
                                                                13 => 'status-pengajuanRetur',
                                                                14 => 'status-returDiterima',
                                                                15 => 'status-pengirimanKembali',
                                                                16 => 'status-returDitolak',
                                                                default => '',
                                                            };
                                                            ...
                                                            $statusText = match ($order->status) {
                                                                ...
                                                                12 => 'Barang Sampai',
                                                                13 => 'Pengajuan Retur',
                                                                14 => 'Retur Diterima, kirim balik',
                                                                15 => 'Pengiriman Retur',
                                                                16 => 'Retur Ditolak, Transaksi selesai',
                                                                default => 'Unknown',
                                                            };
                                                        @endphp
