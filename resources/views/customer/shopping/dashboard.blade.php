                ...
                <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active rounded">
                            <img src="{{asset('img/lemari.jpg')}}" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                            {{-- <a href="#" class="btn px-4 py-2 text-white rounded">Lemari</a> --}}
                        </div>
                        <div class="carousel-item rounded">
                            <img src="{{asset('img/meja.jpg')}}" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                                        ...
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-0">Rp {{$listProduk[$i]->harga_produk}}</p>
