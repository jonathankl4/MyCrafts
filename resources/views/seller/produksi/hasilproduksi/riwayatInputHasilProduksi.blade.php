                ...
                <table id="tMebel" class="table table-striped" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 16px"><b>{{$listRiwayat[$i]->jumlah_diproduksi}}</b><p>berhasil = {{$listRiwayat[$i]->jumlah_berhasil}}</p><p>gagal = {{$listRiwayat[$i]->jumlah_gagal}}</p></td>
                            <td style="font-size: 16px"><b>{{$listRiwayat[$i]->durasi}} Hari</b></td>
