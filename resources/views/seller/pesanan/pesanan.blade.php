                    ...
                    <table id="tMebel" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 16px"><b>{{\Carbon\Carbon::parse($pembelian[$i]->tgl_transaksi)->translatedFormat('j F Y')}}</b></td>
                                <td style="font-size: 16px"><b>Rp. {{number_format($pembelian[$i]->perkiraan_harga, 0, ',', '.')}}</b></td>
                                @php
                            ...
                            <td style="font-size: 16px"><b><span class="badge {{$color}}">{{$status}}</span></b></td>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('seller/detailPesanan/'.$pembelian[$i]->id)}}" class="btn btn-info">Detail Pesanan</a>
                                </td>
