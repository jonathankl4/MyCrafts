        ...
        <form action="{{url('seller/addProduk')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card" style="padding: 15px">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="beratProduk" name="beratProduk" placeholder="Berat Produk"  value="{{old('beratProduk')}}" />
                ...
                <div class="mb-3">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control" id="ukuranPanjang" name="ukuranPanjang" placeholder="Panjang"   value="{{old('ukuranPanjang')}}"/>
                        <span style="color: red;">{{ $errors->first('ukuranPanjang')}}</span>
                        <input type="text" class="form-control" id="ukuranLebar" name="ukuranLebar" placeholder="Lebar" value="{{old('ukuranLebar')}}"  />
                        <span style="color: red;">{{ $errors->first('ukuranLebar')}}</span>
                        <input type="text" class="form-control" id="ukuranTinggi" name="ukuranTinggi" placeholder="Tinggi" value="{{old('ukuranTingggi')}}" />
