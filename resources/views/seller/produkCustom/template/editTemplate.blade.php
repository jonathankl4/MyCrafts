...
<div class="content-wrapper">
    ...
    <div class="flex-grow-1 container-p-y" style="width: 100% ; padding: 1cm ">
        ...
        <form action="{{url('seller/editTemplate/'.$template->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card" style="padding: 15px">
                <h3 class="card-header text-dark ">Informasi Template</h3>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="nama Template"  value="{{$template->nama}}"/>
                        <span style="color: red;">{{ $errors->first('nama')}}</span>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" >tipe</label>
                        <input type="text" class="form-control" id="tipe" name="tipe" placeholder="Tipe Template" value="{{$template->tipe}}" />
                        <span style="color: red;">{{ $errors->first('tipe')}}</span>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" >Harga</label>
                        <input type="text" class="form-control" id="harga" name="harga" placeholder="Harga"  value="{{$template->harga}}" />
                        <span style="color: red;">{{ $errors->first('harga')}}</span>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" >Keterangan</label>
                        <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan Template"  value="{{$template->keterangan}}" />
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-10">
                            ...
                            <img src="{{url("/storage/imgTemplate/".$template->gambar)}}" alt="" style="width:100px; height:100px" >
