            ...
            <div class="container topbar bg-dark d-none d-lg-block">
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        <small class="me-3"><i class="fas  me-2 text-secondary"></i> <a href="#" class="text-white">Welcome to MyCrafts</a></small>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <h1 class="mb-5 display-3 text-primary">Temukan Meja dan lemari terbaikmu</h1>
